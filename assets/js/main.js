(function($) {
    ...
    // burger menu
    var menuicon = document.querySelector('.open_burger');
    var addclass = document.querySelector('.sidebar');
    menuicon.addEventListener('click', function() {
        addclass.classList.toggle('sidebarshow');
        addclass.style.transition = '2s';
    });
    console.log(menuicon.length)
